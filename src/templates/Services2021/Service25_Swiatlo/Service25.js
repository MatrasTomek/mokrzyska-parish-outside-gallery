...
const Service25 = () => {
  ...
  const catalogName = "swiatlo_2021";
  // const pictureEnd = "";
  ...
  return (
    <div className={styles.wrapper}>
      <h3>Światełko Pokoju</h3>
      <p>
        19.12.2021r. na Mszy świętej o godzinie 10.30 – Drużyna Harcerska „Leśna
        Dziatwa” przekaże naszej parafii Betlejemskie{" "}
        <span>Światełko Pokoju</span>. Ogień na stół wigilijny będzie można w
        parafii odbierać do piątku 24 grudnia
      </p>
