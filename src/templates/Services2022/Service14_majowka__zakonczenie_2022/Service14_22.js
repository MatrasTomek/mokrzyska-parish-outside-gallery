...
const Service14_22 = () => {
	...
	const catalogName = "majowka_zakonczenie_2022";
	// const pictureEnd = "";
	...
	return (
		<div className={styles.wrapper}>
			<h3>Ukoronowanie Nabożeństw majowych przy kapliczce Matki Bożej z Dzieciątkiem przy ulicy Sąsiedzkiej</h3>

			<p>Mokrzyska 28.05.2022r.</p>
